...
pub struct RayTracingDescriptorSet {
...
impl Drop for RayTracingDescriptorSet {
    fn drop(&mut self) {
        self.device
...
pub struct RayTracingDescriptorSetBuilder<'a> {
...
impl<'a> RayTracingDescriptorSetBuilder<'a> {
    pub fn new(
        context: &'a VulkanContext,
        camera_buffer: &'a Buffer,
        geometry_instance: &'a GeometryInstance,
    ...
    pub fn build(self) -> Result<RayTracingDescriptorSet, VulkanError> {
